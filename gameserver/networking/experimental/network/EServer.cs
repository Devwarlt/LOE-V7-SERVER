...
namespace LoESoft.GameServer.networking.experimental
{
    public class EServer
    {
            ...
            )
        {
            ...
            _eventArgsPoolAccept = new ESocketAsyncEventArgsManager(MaxSimultaneousAcceptOps);
            _clientManager = new EClientManager(maxConnections + 1);
        ...
        private readonly ESocketAsyncEventArgsManager _eventArgsPoolAccept;
        ...
        internal readonly EClientManager _clientManager;
        ...
        private SocketAsyncEventArgs CreateNewSendEventArgs()
        {
            ...
            eventArgs.UserToken = new EOutgoingToken(eventArgs.Offset);
            return eventArgs;
        }
        ...
        private SocketAsyncEventArgs CreateNewReceiveEventArgs()
        {
            var eventArgs = new SocketAsyncEventArgs();
            _buffManager.SetBuffer(eventArgs);
            eventArgs.UserToken = new EIncomingToken(eventArgs.Offset);
            return eventArgs;
        }
