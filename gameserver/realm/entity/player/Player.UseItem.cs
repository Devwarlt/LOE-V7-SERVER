                    ...
                    case ActivateEffects.IncrementStat:
                        {
                            ...
                            if (eff.Stats == StatsType.MAX_HP_STAT) idx = 0;
                            else if (eff.Stats == StatsType.MAX_MP_STAT) idx = 1;
                            else if (eff.Stats == StatsType.ATTACK_STAT) idx = 2;
                            else if (eff.Stats == StatsType.DEFENSE_STAT) idx = 3;
                            else if (eff.Stats == StatsType.SPEED_STAT) idx = 4;
                            else if (eff.Stats == StatsType.VITALITY_STAT) idx = 5;
                            else if (eff.Stats == StatsType.WISDOM_STAT) idx = 6;
                            else if (eff.Stats == StatsType.DEXTERITY_STAT) idx = 7;
                    ...
                    case ActivateEffects.StatBoostSelf:
                        {
                            ...
                            else if (eff.Stats == StatsType.DEXTERITY_STAT) idx = 5;
                            else if (eff.Stats == StatsType.VITALITY_STAT) idx = 6;
                            else if (eff.Stats == StatsType.WISDOM_STAT) idx = 7;
                    ...
                    case ActivateEffects.StatBoostAura:
                        {
                            ...
                            if (eff.Stats == StatsType.MAX_HP_STAT) idx = 0;
                            if (eff.Stats == StatsType.MAX_MP_STAT) idx = 1;
                            if (eff.Stats == StatsType.ATTACK_STAT) idx = 2;
                            if (eff.Stats == StatsType.DEFENSE_STAT) idx = 3;
                            if (eff.Stats == StatsType.SPEED_STAT) idx = 4;
                            if (eff.Stats == StatsType.DEXTERITY_STAT) idx = 5;
                            if (eff.Stats == StatsType.VITALITY_STAT) idx = 6;
                            if (eff.Stats == StatsType.WISDOM_STAT) idx = 7;
                    ...
                    case ActivateEffects.AccountLifetime:
                        {
                            ...
                            {
                                GameId = (int)WorldID.ISLE_OF_APPRENTICES, // change to Drasta Citadel in future versions!
                                Host = string.Empty,
