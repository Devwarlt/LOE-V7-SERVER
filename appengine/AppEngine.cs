...
namespace LoESoft.AppEngine
{
    internal class AppEngine
    {
        ...
        internal static AppEngineMonitor AppEngineInstance
        { get; set; }

        public static readonly ILog log = LogManager.GetLogger(typeof(AppEngine));
        ...
        private static void Main(string[] args)
        {
            ...
            using (Database = new Database())
            {
                ...
                AppEngineInstance = new AppEngineMonitor(Restart);
